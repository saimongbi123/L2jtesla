...
import dev.l2j.tesla.autobots.behaviors.preferences.skills.HellKnightSkillPreferences
...
internal class HellKnightBehavior(player: Player, combatPreferences: CombatPreferences) : CombatBehavior(player, combatPreferences),
    PetOwner {
    ...
    override val summonInfo: Pair<BotSkill, MiscItem?> = Pair(BotSkill(summonDarkPanther) { player, _, _ -> !player.isInCombat },
        MiscItem({ 1459 }, 50, 10)
    )
