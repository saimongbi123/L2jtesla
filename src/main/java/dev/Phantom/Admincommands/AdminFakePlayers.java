...
public class AdminFakePlayers implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, Player activeChar)
	{
		...
		if (command.startsWith("admin_fakeaden")) {

			activeChar.sendMessage("Aden Walker Fake Player");

			{
				FakePlayer fakePlayer = FakePlayerManager.spawnPlayer4(Config.ENABLE_ADEN_TO);
		...
		if (command.startsWith("admin_fakegludin")) {

			activeChar.sendMessage("Gludin Walker Fake Player");

			{
				FakePlayer fakePlayer = FakePlayerManager.spawnPlayer5(Config.ENABLE_GLUDIN_TO);
		...
		if (command.startsWith("admin_fakedion")) {

			activeChar.sendMessage("Dion Walker Fake Player");

			{
				FakePlayer fakePlayer = FakePlayerManager.spawnPlayer6(Config.ENABLE_DION_TO);
	...
	static class WhileLoopExample2
	{
		public static void spawnwalker(int x, int y, int z)
		{
			int i = 24;
	...
	static class WhileLoopExample3
	{
		public static void spawnwalker(int x, int y, int z)
		{
			int i = 24;
	...
	static class WhileLoopExample6
	{
		public static void spawnwalker(int x, int y, int z)
		{
			int i = 24;
