...
public final class RequestPrivateStoreBuy extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((storePlayer == null) || !player.isInsideRadius(storePlayer, Npc.INTERACTION_DISTANCE, true, false) || !(storePlayer.getStoreType() == StoreType.SELL || storePlayer.getStoreType() == StoreType.PACKAGE_SELL))
			return;
		...
		if ((storePlayer.getStoreType() == StoreType.PACKAGE_SELL && storeList.getItems().size() > _items.size()) || !storeList.privateStoreBuy(player, _items))
			return;
