...
public final class PartySmallWindowAll extends L2GameServerPacket
{
	...
	public PartySmallWindowAll(Player exclude, Party party)
	{
		...
		_dist = (_party.getLootRule() != null) ? _party.getLootRule().ordinal() : 0; // Evita NPE se lootRule for null
	}
	...
	protected final void writeImpl()
	{
		...
		writeD(_dist);
		writeD(_party.getMembersCount() - (_exclude != null ? 1 : 0)); // Ajusta contagem se _exclude existir
