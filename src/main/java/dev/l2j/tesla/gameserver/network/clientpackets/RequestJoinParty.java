...
import dev.l2j.tesla.autobots.Autobot; // Import do Autobot do Kotlin
...
public final class RequestJoinParty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		// Lógica pra Autobot do Kotlin aceitar party
		if (target instanceof Autobot)
		{
			((Autobot) target).acceptPartyInvite(requestor); // Chama o método do Autobot.kt
