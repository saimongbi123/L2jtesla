...
public class MultiSellChoose extends L2GameClientPacket
{
	...
	public void runImpl()
	{
		...
		if (!FloodProtectors.performAction(getClient(), FloodProtectors.Action.MULTISELL) || _amount < 1 || _amount > 9999)
		{
		...
		if (list == null || list.getId() != _listId || _entryId < 1 || _entryId > list.getEntries().size())
		{
			player.setMultiSell(null);
			return;
		}
		...
		if ((entry == null) || (!entry.isStackable() && _amount > 1))
		{
			player.setMultiSell(null);
			return;
		}
