...
public final class RequestMagicSkillUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((player == null) || AutobotsManager.INSTANCE.onUseMagic(player, _skillId, _ctrlPressed)) {
			return;
		}
		...
		if ((skill == null) || (skill.getSkillType() == L2SkillType.RECALL && !Config.KARMA_PLAYER_CAN_TELEPORT && player.getKarma() > 0))
		{
