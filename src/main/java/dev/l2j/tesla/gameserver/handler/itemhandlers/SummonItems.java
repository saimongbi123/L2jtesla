...
public class SummonItems implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		if (player.isInObserverMode() || player.isAllSkillsDisabled() || player.isCastingNow())
			return;
	...
	static class PetSummonFinalizer implements Runnable
	{
		...
		public void run()
		{
			...
			if (_item == null || _item.getOwnerId() != _player.getObjectId() || _item.getLocation() != ItemInstance.ItemLocation.INVENTORY || (World.getInstance().getPet(_player.getObjectId()) != null))
				return;
