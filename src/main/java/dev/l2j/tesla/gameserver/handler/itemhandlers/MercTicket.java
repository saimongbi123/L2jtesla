...
public class MercTicket implements IItemHandler
{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		// Max amount check.
		if (castle.getSiege().isInProgress() || !SevenSignsManager.getInstance().isSealValidationPeriod() || !ticket.isSsqType(SevenSignsManager.getInstance().getSealOwner(SealType.STRIFE)) || (castle.getDroppedTicketsCount(itemId) >= ticket.getMaxAmount()))
		{
