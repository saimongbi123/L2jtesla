...
public class ZoneCuboid extends ZoneForm
{
	...
	public boolean intersectsRectangle(int ax1, int ax2, int ay1, int ay2)
	{
		...
		if (lineSegmentsIntersect(_x1, _y1, _x1, _y2, ax1, ay1, ax2, ay1) || lineSegmentsIntersect(_x1, _y1, _x1, _y2, ax1, ay2, ax2, ay2) || lineSegmentsIntersect(_x2, _y1, _x2, _y2, ax1, ay1, ax2, ay1) || lineSegmentsIntersect(_x2, _y1, _x2, _y2, ax1, ay2, ax2, ay2))
			return true;
